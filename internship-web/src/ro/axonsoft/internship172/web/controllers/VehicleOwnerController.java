...
public class VehicleOwnerController {
     ...
     *
     * @param vehicleOwner
     *            obiectul returnat de pe model care trebuie salvat in baza de
     *            date
     ...
     * @param model
     * @param pageSize dimensiunea paginii in momentul inserarii
     * @param currentPage pagina pe care se aflta utilizatorul
     * @return lista
     */
     ...
     */
    @PostMapping("/deleteVehicleOwner/{vehicleOwnerId}")
    public String vehicleOwnerDelete(@PathVariable("vehicleOwnerId") final Long vehicleOwnerId,
            @ModelAttribute("vehicleOwner") final MdfVehicleOwner vehicleOwner) {
        final RestTemplate restTemplate = new RestTemplate();
        LOG.info("se sterge " + vehicleOwner.toString());

        String uri = LOCAL_SERVER;
        uri += "rest/v1/vehicleOwners/deleteVehicleOwnerById";
        uri += "/";
        uri += vehicleOwnerId;
