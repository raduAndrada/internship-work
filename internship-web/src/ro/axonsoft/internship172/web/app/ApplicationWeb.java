...
@Import({ DataConfiguration.class, BusinessConfiguration.class, ApplicationConfiguration.class, MvcConfig.class })
...
//
//    @Inject
//    public void setProcessingProperties(final VehicleOwnersProcessingProperties processingProperties) {
...
//            try (FileInputStream inStream = new FileInputStream(processingProperties.getInputFile())) {
//                try (FileOutputStream outStream = new FileOutputStream(processingProperties.getOutputFile())) {
