...
import ro.axonsoft.internship172.api.ImtVehicleOwnersMetrics;
    ...
    public void test() throws Exception {
        ...
        try (final ObjectInputStream resIn = new ObjectInputStream(new FileInputStream(outputFile))) {
            ...
            assertThat(result).isEqualTo(ImtVehicleOwnersProcessResult.builder()
                    .metrics(ImtVehicleOwnersMetrics.builder()
                         .oddToEvenRatio(200)
                         .putUnregCarsCountByJud("MM", 3)
                         .passedRegChangeDueDate(0)
                        .build())
                    .addErrors(ImtVehicleOwnerParseError.builder()
                        .line(1)
                        .type(0)
                        .build())
                    .build());
