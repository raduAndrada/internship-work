...
import ro.axonsoft.internship172.api.ImtRoIdCardProperties;
...
public class RoIdCardParserImpl implements RoIdCardParser, Serializable {
     ...
     * RoIdCardProperties arunca o exceptie daca stringul nu corespunde cu o
     * carte
    ...
    public RoIdCardProperties parseIdCard(final String idCard) throws InvalidRoIdCardException {
        ...
        return ImtRoIdCardProperties.builder()
                .judet(judet)
                .series(series)
                .number(digits)
                .build();
