...
public class RoRegPlateParserTest {
	...
	/**
	 * Excepție așteptată când în secțiunea dedicată literelor există
	...
	public void suc_lower_nospace() throws InvalidRoRegPlateException {
		final RoRegPlateProperties res = subject.parseRegistrationPlate("cj10adc");
		assertThat(ImtRoRegPlateProperties.copyOf(res))
				.isEqualTo(ImtRoRegPlateProperties.builder().judet(Judet.CJ).letters("ADC").digits((short) 10).build());
	}
	...
	public void suc_jud_all() throws InvalidRoRegPlateException {
		final Set<String> juds = new TreeSet<>(Arrays.asList("AB", "AR", "AG", "BC", "BH", "BN", "BT", "BV", "BR", "BZ",
				"CS", "CJ", "CT", "CV", "DB", "DJ", "GL", "GJ", "HR", "HD", "IL", "IS", "IF", "MM", "MH", "MS", "NT",
				"OT", "PH", "SM", "SJ", "SB", "SV", "TR", "TM", "TL", "VS", "VL", "VN", "B", "CL", "GR"));
