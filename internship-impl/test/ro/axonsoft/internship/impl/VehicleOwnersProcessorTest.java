...
public class VehicleOwnersProcessorTest {
	...
	private static final Date REF_DATE = Date
			.from(LocalDate.parse("2017-04-13").atStartOfDay(ZoneId.systemDefault()).toInstant());
	...
	/**
	 * CJ636141;2012-09-25;CJ84ADC; CJ636141;2012-09-25;CJ81ADC;
	...
	/**
	 * CJ636141;2012-03-13;MM84ADC; CJ636141;2012-03-14;MM81ADC;
	 * CJ636141;2012-03-15;MM85ADC; MM636141;2012-03-13;CJ84ADC;
	 * MM636141;2012-03-14;CJ81ADC; MM636141;2012-03-15;CJ85ADC;
	 */
	@Test
	...
	/**
	 * CJ636141;2012-09-25;XCJ84ADC; CJ636141;2012-09-25;;
	 * CJ636141;2012-09-25;CJ85ADC; MM636141;2012-09-25;XCJ84ADC;
	...
	public void correctFocusUnregVehicles() throws Exception {
		...
		assertThat(result.getErrors()).isEmpty();
		assertThat(result.getUnregCarsCountByJud()).isEqualTo(ImmutableMap.of("CJ", 2, "MM", 1));
	}
	...
	/**
	 * Fișierul conține cărți de indentitate și numere de înmatriculare cu
	 * litere mici.
	 */
	@Test
	...
	public void errorsInvalidLines() throws Exception {
		...
		assertThat(result.getErrors())
				.isEqualTo(ImmutableSet.of(ImtVehicleOwnerParseError.builder().line(1).type(0).build(),
	...
	public void errorsInvalidIdCards() throws Exception {
		...
		assertThat(result.getErrors())
				.isEqualTo(ImmutableSet.of(ImtVehicleOwnerParseError.builder().line(1).type(1).build(),
	...
	public void errorsInvalidIdCardIssueDates() throws Exception {
		...
		assertThat(result.getErrors())
				.isEqualTo(ImmutableSet.of(ImtVehicleOwnerParseError.builder().line(1).type(2).build(),
						ImtVehicleOwnerParseError.builder().line(2).type(2).build()));
	}

	/**
	 * Fișierul conține linii unele erori. Se evaluează și rezultatul pe liniile
	 * corecte.
	 */
	@Test
	public void complex() throws Exception {
		...
		assertThat(result.getErrors())
				.isEqualTo(ImmutableSet.of(ImtVehicleOwnerParseError.builder().line(4).type(2).build(),
						ImtVehicleOwnerParseError.builder().line(7).type(1).build(),
						ImtVehicleOwnerParseError.builder().line(7).type(2).build()));
		assertThat(result.getUnregCarsCountByJud()).isEqualTo(ImmutableMap.of("B", 2, "CJ", 1, "MM", 1));
	...
	private static class ResultAdapter {
		...
		public Set<VehicleOwnerParseError> getErrors() {
			return Optional.fromNullable(result.getErrors()).or(ImmutableSet.of()).stream()
					.map(ImtVehicleOwnerParseError::copyOf).collect(Collectors.toCollection(Sets::newLinkedHashSet));
		}
	}
}
